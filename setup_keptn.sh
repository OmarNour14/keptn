...
echo "================================================================================="
keptn add-resource --project=$KEPTN_PROJECT --service=$KEPTN_SERVICE_NAME --all-stages --resource=./keptn/helloworld-chart-0.1.0.tgz --resourceUri=helm/$KEPTN_SERVICE_NAME.tgz
